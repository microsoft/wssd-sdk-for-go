...
type Service interface {
	Get(context.Context, string, string) (compute.VirtualCompute, error)
	CreateOrUpdate(context.Context, string, string, compute.VirtualCompute) (compute.VirtualCompute, error)
