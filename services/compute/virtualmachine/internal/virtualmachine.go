...
func (c *client) getWssdVirtualMachineZoneConfiguration(zoneProfile *compute.ZoneProfile) (*wssdcommonproto.ZoneConfiguration, error) {
	if zoneProfile == nil {
		return nil, nil
	}
