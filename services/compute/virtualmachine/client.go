...
func (c *VirtualMachineClient) DeleteCheckpoint(ctx context.Context, vmName, checkpointName string) (err error) {
	return c.internal.DeleteCheckpoint(ctx, vmName, checkpointName)
}
