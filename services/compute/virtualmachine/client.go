...
type Service interface {
	...
	DiscoverVm(context.Context, string) (*[]compute.VirtualMachineDiscovery, error)
}
...
func (c *VirtualMachineClient) Hydrate(ctx context.Context, group string, name string) (*compute.VirtualMachine, error) {
...
func (c *VirtualMachineClient) DiscoverVm(ctx context.Context, group string) (*[]compute.VirtualMachineDiscovery, error) {
	return c.internal.DiscoverVm(ctx, group)
}
