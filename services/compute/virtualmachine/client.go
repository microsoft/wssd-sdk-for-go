...
func (c *VirtualMachineClient) Delete(ctx context.Context, group string, name string, compute *compute.VirtualMachine) error {
	return c.internal.Delete(ctx, group, name, compute)
}
