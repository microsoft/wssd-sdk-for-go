...
// Get
func (c *client) Get(ctx context.Context, group, name string) (VirtualNetwork, error) {
	return c.VirtualNetworkAgentClient.Invoke(ctx, group, name, "")
}

// CreateOrUpdate
func (c *client) CreateOrUpdate(ctx context.Context, name string, id string, sg VirtualNetwork) (VirtualNetwork, error) {
	f, err := c.VirtualNetworkAgentClient.Invoke(ctx, group, name, sg)
	if err != nil {
	...
	return f.Result(c.VirtualNetworksClient)
}
