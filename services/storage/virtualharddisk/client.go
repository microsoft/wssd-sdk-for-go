...
type Service interface {
	...
	Hydrate(context.Context, string, string) (*storage.VirtualHardDisk, error)
}
...
func (c *VirtualHardDiskClient) Hydrate(ctx context.Context, container, name string) (*storage.VirtualHardDisk, error) {
	return c.internal.Hydrate(ctx, container, name)
}
