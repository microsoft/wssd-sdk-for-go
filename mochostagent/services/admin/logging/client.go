...
import (
	...
	"github.com/microsoft/wssd-sdk-for-go/mochostagent/services/admin/logging/internal"
)
...
// gets a file from the corresponding host agent and writes it to filename
