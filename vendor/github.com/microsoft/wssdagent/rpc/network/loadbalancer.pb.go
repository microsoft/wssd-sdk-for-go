...
type LoadBalancer_LoadBalancerType int32

const (
	LoadBalancer_NonDSR LoadBalancer_LoadBalancerType = 0
	LoadBalancer_DSR    LoadBalancer_LoadBalancerType = 1
)

var LoadBalancer_LoadBalancerType_name = map[int32]string{
	0: "NonDSR",
	1: "DSR",
}

var LoadBalancer_LoadBalancerType_value = map[string]int32{
	"NonDSR": 0,
	"DSR":    1,
}

func (x LoadBalancer_LoadBalancerType) String() string {
	return proto.EnumName(LoadBalancer_LoadBalancerType_name, int32(x))
}

func (LoadBalancer_LoadBalancerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d60ee00bafda1595, []int{2, 0}
}
...
type LoadBalancer struct {
	...
	Type                 LoadBalancer_LoadBalancerType `protobuf:"varint,3,opt,name=type,proto3,enum=wssd.network.LoadBalancer_LoadBalancerType" json:"type,omitempty"`
...
func (m *LoadBalancer) GetType() LoadBalancer_LoadBalancerType {
	if m != nil {
		return m.Type
	}
	return LoadBalancer_NonDSR
}
...
func init() {
	proto.RegisterEnum("wssd.network.LoadBalancer_LoadBalancerType", LoadBalancer_LoadBalancerType_name, LoadBalancer_LoadBalancerType_value)
...
var fileDescriptor_d60ee00bafda1595 = []byte{
	...
	,
}
