...
echo "Generating $Module protoc"
protoc -I $Module/common $Module/common/common.proto --go_out=plugins=grpc:$Module
protoc -I $Module/identity -I $Module/common $Module/identity/identity.proto --go_out=plugins=grpc:$Module
...
protoc -I $Module/authentication -I $Module/common -I $Module/identity $Module/authentication/authentication.proto --go_out=plugins=grpc:$Module